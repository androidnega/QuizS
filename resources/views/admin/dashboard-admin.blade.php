...
<div class="w-full space-y-6">
    ...
    <section class="rounded-lg border border-gray-200 bg-white p-4">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('dashboard.class-groups.index') }}" class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 hover:bg-gray-100 hover:border-gray-300 transition-colors" title="Manage student groups and assign courses">
            ...
            <a href="{{ route('dashboard.courses.index') }}" class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 hover:bg-gray-100 hover:border-gray-300 transition-colors" title="Create and manage course catalog">
